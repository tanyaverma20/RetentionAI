...
export default function SurveyForm({ employeeId, onSubmit, onCancel }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 bg-slate-900 p-6 rounded-3xl border border-slate-800">
      <h2 className="text-xl font-bold text-slate-100">Submit Engagement Survey</h2>
      ...
      <div>
        <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">Additional Comments</label>
        <textarea
          name="surveyComments"
          rows={4}
